...
## Project Structure
    ...
    ├── testapiautocatalog_118746  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_118746`
...
2. Clone this repo and `cd testapiautocatalog_118746`
